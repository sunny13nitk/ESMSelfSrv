...
@AllArgsConstructor
@NoArgsConstructor
public class TY_Case_CustomerAddUser_SrvCloud
{
    ...
    private List<TY_AddUserCaseCreate> customIndividualCustomers = new ArrayList<TY_AddUserCaseCreate>();
    ...
    {
        return "TY_Case_SrvCloud [subject=" + subject + ", caseType=" + caseType + ", account=" + individualCustomer
